...
//        
//        pauseButtonInScreenPosition = self.convertPointToIpadUp(CGPointMake(-sceneSize.width + 320, 300))
...
//        self.pauseButton?.runAction(movePauseButton)
    ...
    class func convertPointToIpadUp(point: CGPoint) -> CGPoint{
...
//            return CGPointMake(32 + point.x*2, 64 + point.y*2);
    ...
    class func convertPointToIpadDown(point: CGPoint) -> CGPoint{
